...
<div class="row">
    <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <p>mohon isi data di bawah ini</p>
            <form action="<?php echo URLROOT; ?>/users/register" method="post">
                ...
                <div class="form-group mb-3">
                    <label for="confirm_password">Masukan Password anda lagi: <sup>*</sup></label>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="<?php echo URLROOT; ?>/users/login" class="btn btn-light btn-block">sudah punya akun </a>
                    </div>
                </div>
            </form>
        </div>
